...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for feature in self.featExtractor.getFeatures(state, action):
            qVal += self.getWeights()[feature] * self.featExtractor.getFeatures(state, action)[feature]
        return qVal
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature in self.featExtractor.getFeatures(state, action):
            self.getWeights()[feature] += self.alpha * difference * self.featExtractor.getFeatures(state, action)[
                feature]
